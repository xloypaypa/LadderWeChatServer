...
public class RSA {
    ...
    public static PublicKey bytes2PublicKey(byte[] bytes) {
        ...
        try {
            ...
            closeStream(byteArrayInputStream, objectInputStream);
        }
        return publicKey;
    }

    public static PrivateKey bytes2PrivateKey(byte[] bytes) {
    ...
    private static void closeStream(ByteArrayInputStream byteArrayInputStream, ObjectInputStream objectInputStream) {
        try {
